...
/* harmony import */ var _components_cases_content__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/cases-content */ "./src/js/components/cases-content.js");
/* harmony import */ var _components_cases_content__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_cases_content__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _components_validation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/validation */ "./src/js/components/validation.js");
 ...
 // import "./components/btn-go-back";

 // import "./components/ty-close";
...
/***/ "./src/js/components/cases-content.js":
/*!********************************************!*\
  !*** ./src/js/components/cases-content.js ***!
  \********************************************/
/***/ (() => {

const rdySolContent = document.querySelector('.rdy-solutions-content');
const scheme = document.querySelector('.scheme');
const caseContent = document.createElement('div');
caseContent.classList.add('case-content');
const caseContentLeftSide = document.createElement('div');
caseContentLeftSide.classList.add('case-content__left-side');
const caseContentRightSide = document.createElement('div');
caseContentRightSide.classList.add('case-content__right-side');
const case1 = {
  title: 'The order for the temperature for the continuous-casting machine',
  problem: 'The order for the temperature can be done with the indubitable exceedance of the optimal temperature - thermal overload - to lower the risk of metal subcooling in the casting. This approach leads to the overuse of electricity, ferrous materials, graphite electrodes and other materials. On the other hand, the imprecision in the order of the temperature due to the human factor, can lead to the order of the lower temprature. It can cause the emergency casting.',
  decision: 'To automate the order of the temperature using the machine learning algorithms. We can rate the optimal temperature of the metal delivery from the ladle furnace, using the data of steel chemestry, the necessary thermal overload of liquidus, the historical data of slabs, stags, etc.',
  list: ''
};
const case2 = {
  title: 'The automated system of steel shaping up optimization at the ladle furnace',
  problem: 'It is almost impossible for the human to take into account all the factors influencing the acquisition of the ferrous materials during the steel ladle treatment. Due to this, in the smelting process the minimal derivation from the minimal chemical figures is not stable and is usually far from the minimal data. Also, the steelworker uses not the ferrous materials only but also reduction alloys and slag-forming materials during the ladle-forming process. The usage of all these materials influences on the cost and quality of steel.',
  decision: 'To automate the computing of the needed ferrous alloys sub-samples, reduction alloys and slag-forming materials. Due to this the needed steel chemestry is produced with the minimal derivarion from the target numbers and target cost.',
  list: ''
};
const case3 = {
  title: 'The portfolio of blending optimization in order to stabilize EAF performance and lower the expenses on the scrap metal usage, handling and supply   ',
  problem: 'As far as the market of scrap metal is changeable and unpredictable the search for the consistent blending and supply prediction for the upcoming periods are one of the most relevant tasks which can produce the economy per 1 ton of steel. The number of variants, multifactorial nature of scrap metal influence on the price of the liquid steel do not afford to search for the best decision based on the experience only. Dozens of various factory departments are involved into this process. As usual they solve only local optimizating tasks that usually dramatically increase the expenses with the end-to-end analysis',
  decision: 'The special product is created to work with the scrap in forming the blending and scrap metal supply. The product includes: The calculation of the optimal blending taking into account the metallurgical price of the scrap metal per 1 ton of the liquid steel.',
  list: `<ul class="case-modal-content__list list-reset">
          <li class="case-modal-content__item">
            The control of&nbsp;the optimal blending production.
          </li>
          <li class="case-modal-content__item">
            The recommendations for the layers placing.
          </li>
          <li class="case-modal-content__item">
            The &laquo;what&nbsp;if&raquo; module.
          </li>
          <li class="case-modal-content__item">
            The control of&nbsp;the optimal blending production.
          </li>
          <li class="case-modal-content__item">
            The planning of&nbsp;the supply taking into account the presence
            of&nbsp;the scrap metal, the price of&nbsp;the delivery, the maximizing of&nbsp;the processing and the
            programm for the further production programms.
          </li>
        </ul>`
};
const case4 = {
  title: 'The recommendation system for the optimization of the heat-treatment processes',
  problem: 'Usually we try to optimize the heat-treatment processes on the production line and saving of the resources. While all these optimization processes can lead to the defectives in the heat-treatment and double procedures, thus, it can lead to the increase of the expenses.',
  decision: 'To create the recommendation system for the heat-treatment processes. The system controlls and recommends the necessary temperature and time of being in the headings and quench, the time for cooling in the sprayer and quenching bath in order to maintain the best quality of the production. The system corrects the heat-treatment processes automatically according to the metal chemestry and unit size.',
  list: ''
};
const casesContentList = [case1, case2, case3, case4];
const params = new URLSearchParams(window.location.search);
const currentPageId = params.get('id');

for (let i = 1; i < casesContentList.length + 1; i++) {
  if (i == currentPageId) {
    caseContentLeftSide.innerHTML = `
        <div class="case-modal-content case-modal-content--id-case">
          <h2 class="case-modal-content__title case-modal-content__title--small">
            ${casesContentList[i - 1].title}
          </h2>
          <ul class="case-modal-content__info list-reset">
            <li class="case-modal-content__elem">
              <h3 class="case-modal-content__descr-title case-modal-content__descr-title--problem">
                <span>
                  The problem
                </span>
              </h3>
              <p class="case-modal-content__descr">
              ${casesContentList[i - 1].problem}
              </p>
            </li>
            <li class="case-modal-content__elem">
              <h3 class="case-modal-content__descr-title case-modal-content__descr-title--decision">
                <span>
                  Solution
                </span>
              </h3>
              <p class="case-modal-content__descr">
              ${casesContentList[i - 1].decision}
              </p>
              ${casesContentList[i - 1].list}
            </li>
          </ul>
          <form action="#" class="case-modal-content__form form" method="POST" enctype="multipart/form-data">
            <label class="form__label">
              <input class="input input-name form__elem" type="text" data-validate-field="name" name="Name"
                placeholder="Name">
            </label>
            <label class="form__label">
              <input class="input input-tel form__elem" type="tel" data-validate-field="tel" name="Phone"
                placeholder="Phone">
            </label>
            <label class="form__label">
              <input class="input input-mail form__elem" type="email" data-validate-field="email" name="Email"
                placeholder="Email">
            </label>
            <label class="form__label">
              <textarea class="textarea form__elem" name="Comment" id="" cols="30" rows="5"
                placeholder="Comment"></textarea>
            </label>
            <button class="form__btn form__btn--send main-btn btn-reset">Send</button>
            <label class="form__btn form__btn--file main-btn" for="myfile">
              <svg>
                <use xlink:href="img/sprite.svg#file"></use>
              </svg>
              Download your file
            </label>
            <input class="input visually-hidden" type="file" name="file[]" multiple id="myfile">
          </form>
        </div>
    `;

    if (currentPageId == 1) {
      scheme.style.paddingTop = "650px";
      caseContentRightSide.innerHTML = `
        <ul class="rdy-solutions-list rdy-solutions-list--id-case rdy-solutions-list--cases list-reset">
          <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
            <div class="rdy-solutions-list-item__descr">
            The portfolio of&nbsp;blending optimization in&nbsp;order to&nbsp;stabilize EAF performance and lower the expenses on&nbsp;the scrap metal usage, handling and supply
            </div>
            <button class="btn-reset rdy-solutions-list-item__link" data-graph-path="case-9">Read more</button>
          </li>
          <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
            <div class="rdy-solutions-list-item__descr">
              The recommendation system for the optimization of&nbsp;the heat-treatment processes
            </div>
            <button class="btn-reset rdy-solutions-list-item__link" data-graph-path="case-10">Read more</button>
          </li>
          <li class="rdy-solutions-list-item rdy-solutions-list-item--fluid">
            <a href="/cases.html" class="rdy-solutions-list-item__link">
              <span class="rdy-solutions-list-item__svg-wrapper arrow-icon">
                <svg class="rdy-solutions-list-item__svg arrow-icon__svg">
                  <use xlink:href="img/sprite.svg#arrow"></use>
                </svg>
              </span>
              <span class="rdy-solutions-list-item__txt">
                See all projects
              </span>
            </a>
          </li>
    ...
    if (currentPageId == 2) {
      ...
      <ul class="rdy-solutions-list rdy-solutions-list--id-case rdy-solutions-list--cases list-reset">
        <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
          <div class="rdy-solutions-list-item__descr">
            The order for the temperature for the continuous-casting machine.
          </div>
          <button class="btn-reset rdy-solutions-list-item__link" data-graph-path="case-7">Read more</button>
        </li>
        <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
          <div class="rdy-solutions-list-item__descr">
          The portfolio of&nbsp;blending optimization in&nbsp;order to&nbsp;stabilize EAF performance and lower the expenses on&nbsp;the scrap metal usage, handling and supply
    ...
    if (currentPageId == 3) {
      scheme.style.paddingTop = "1050px";
      caseContentRightSide.innerHTML = `
      <ul class="rdy-solutions-list rdy-solutions-list--id-case rdy-solutions-list--cases list-reset">
        <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
          <div class="rdy-solutions-list-item__descr">
        ...
        <li class="rdy-solutions-list-item rdy-solutions-list-item--small">
          <div class="rdy-solutions-list-item__descr">
            The automated system of&nbsp;steel shaping up&nbsp;optimization at&nbsp;the ladle furnace
          </div>
          <button class="btn-reset rdy-solutions-list-item__link" data-graph-path="case-8">Read more</button>
        </li>
        <li class="rdy-solutions-list-item rdy-solutions-list-item--fluid">
          <a href="/cases.html" class="rdy-solutions-list-item__link">
            <span class="rdy-solutions-list-item__svg-wrapper arrow-icon">
    ...
    rdySolContent.innerHTML = '';
    caseContent.append(caseContentLeftSide, caseContentRightSide);
    rdySolContent.append(caseContent);
  }
}
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectFade, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Scrollbar]);
const heroSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero-slider', {
  ...
  spaceBetween: 10,
  navigation: {
    nextEl: '.hero-slider__btn--prev',
    prevEl: '.hero-slider__btn--next'
  },
  scrollbar: {
...
const modalOverlay = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.graph-modal');
const modals = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll('.graph-modal__container');
const rules = [{
  ...
  tel: true,
  telError: 'Fill in the correct phone number',
  rules: [{
    rule: 'required',
    value: true,
    errorMessage: 'Fill in the phone number!'
  }]
}];
const rules1 = [{
  ruleSelector: '.input-name',
...
const afterForm = () => {
  modal.close();
  new graph_modal__WEBPACK_IMPORTED_MODULE_3__["default"]().open('ty-modal');
};
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.lets-talk__form', rules, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.case-modal-content__form', rules1, afterForm1);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.contact-pm__form', rules2, afterForm2);
