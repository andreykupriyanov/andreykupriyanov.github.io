...
/* harmony import */ var _components_ty_close_btn__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/ty-close-btn */ "./src/js/components/ty-close-btn.js");
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/fslightbox */ "./src/js/components/fslightbox.js");
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_fslightbox__WEBPACK_IMPORTED_MODULE_5__);
...
new (_srexi_purecounterjs__WEBPACK_IMPORTED_MODULE_0___default())({
...
var serviceSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.service-slider', {
  autoplay: {
    delay: 3000,
  ...
  navigation: {
    nextEl: '.service-slider__btn--prev',
    prevEl: '.service-slider__btn--next'
  },
  pagination: {
    el: '.service-slider__pag',
    type: 'bullets',
    clickable: true
  }
});
var feedbackSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.feedback-slider', {
  ...
  navigation: {
    nextEl: '.feedback__btn--prev',
    prevEl: '.feedback__btn--next'
  },
  pagination: {
    el: '.feedback-slider__pag',
    type: 'bullets',
    clickable: true
  }
});
var teamSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.team-slider', {
  wrapperClass: 'team-slider__wrapper',
  slideClass: 'team-slider__slide',
  touchEventsTarget: 'team-slider__wrapper',
  slidesPerView: 'auto',
  direction: 'horizontal',
  spaceBetween: 0,
  loop: true,
  navigation: {
    nextEl: '.team__btn--prev',
    prevEl: '.team__btn--next'
  }
});

/***/ }),

/***/ "./src/js/components/ty-close-btn.js":
/*!*******************************************!*\
  !*** ./src/js/components/ty-close-btn.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var closeBtn = document.querySelector('.ty-modal__close-btn');
var modal = document.querySelector('.ty-modal');
var modalContent = document.querySelector('.ty-modal__content');
var modals = document.querySelectorAll('.graph-modal__container');
closeBtn.addEventListener('click', function (e) {
  e.preventDefault();
  modals.forEach(function (el) {
    el.classList.remove('graph-modal-open');
  });
  modalContent.classList.remove('ty-modal__content--visible');
  modalContent.classList.remove('graph-modal-open', 'fade', 'animate-open');
...
var modalOverlay = (_document = document) === null || _document === void 0 ? void 0 : _document.querySelector('.graph-modal');
var modals = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll('.graph-modal__container');
var tyModalOverlay = (_document3 = document) === null || _document3 === void 0 ? void 0 : _document3.querySelector('.ty-modal');
var tyModal = (_document4 = document) === null || _document4 === void 0 ? void 0 : _document4.querySelector('.ty-modal__content');
var rules = [{
...
var afterForm = function afterForm() {
  ...
  tyModalOverlay.classList.add('graph-modal-open', 'fade', 'animate-open');
  tyModal.classList.add('ty-modal__content--visible');
};

var afterForm2 = function afterForm2() {
  modalOverlay.classList.add('is-open');
  tyModalOverlay.classList.add('graph-modal-open', 'fade', 'animate-open');
  tyModal.classList.add('ty-modal__content--visible');
...
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.meet-form', rules1, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.pres-form', rules, afterForm);
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.city__form', rules2, afterForm2);
